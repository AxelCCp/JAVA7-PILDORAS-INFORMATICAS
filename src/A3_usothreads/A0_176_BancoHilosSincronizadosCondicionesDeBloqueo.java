...
public class A0_176_BancoHilosSincronizadosCondicionesDeBloqueo {
...
class Banco{
	...
	public void transferencia(int cuentaOrigen, int cuentaDestino, double cantidad) {
		...
		if(cuentas[cuentaOrigen]<cantidad) {
			System.out.println("********CANTIDAD INSUFICIENTE***Cta.Origen: " + 
								cuentaOrigen + "***Saldo: " + cuentas[cuentaOrigen] + 
								"***Cantidad intento transferencia: " + cantidad);
			return; 
			
			
		}else {
			System.out.println("********TRANSFERENCIA CORRECTA***Cta.Origen: " + 
								cuentaOrigen + "***Saldo: " + cuentas[cuentaOrigen] + 
