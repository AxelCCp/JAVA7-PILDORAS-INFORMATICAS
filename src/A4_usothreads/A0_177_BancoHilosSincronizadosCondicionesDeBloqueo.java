...
public class A0_177_BancoHilosSincronizadosCondicionesDeBloqueo {
...
class Banco{
	...
	public Banco() {	
		...
		//USAMOS SALDOSUFICIENTE, QUE SERÁ IGUAL AL BLOQUEO.
		//CON ESTO LE DECIMOS QUE EL BLOQUEO DEBE ESTABLECERSE EN BASE A UNA CONDICIÓN..
		//Y ESTA CONDICIÓN SE LLAMA SALDOSUFICIENTE. 
	...
	public void transferencia(int cuentaOrigen, int cuentaDestino, double cantidad) throws InterruptedException {
		...
		//CAMBIAMOS EL IF POR UN WHILE, PARA QUE EL BUCLE SEA INDEFINIDO, MIENTRAS LA CONDICIÓN SEA TRUE.
			while(cuentas[cuentaOrigen]<cantidad) {
				...
				//CAMBIAMOS EL RETURN, POR:
				//CON ESTO DECIMOS, "MIENTRAS LA CONDICIÓN DEL WHILE SEA TRUE, PONEMOS EL HILO A LA ESPERA.	
				//SALDOSUFICIENTE E DE TIPO CONDITION.
		...
		//LE DECIMOS A LOS HILOS QUE DESPIERTEN PARA VER SI YA NO SE CUMPLE LA CONDICIÓN DEL WHILE..
		//..while(cuentas[cuentaOrigen]<cantidad).
		//CON ESTO LOGRAMOS QUE LOS HILOS NO MUERAN.
	...
	//PARA CONDICION EN UN BLOQUEO
	//CAMPO DE TIPO CONDITION
